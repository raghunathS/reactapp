...
var AbstractWrapper = /** @class */ (function () {
    ...
    AbstractWrapper.prototype.findAny = function () {
        var selectors = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            selectors[_i] = arguments[_i];
        }
        return this.find(":is(".concat(selectors.map(function (selector) { return (0, utils_1.getUnscopedClassName)(selector); }).join(', '), ")"));
    };
     ...
     */
    AbstractWrapper.prototype.findAllComponents = function (ComponentClass, selector) {
        var componentRootSelector = ".".concat(ComponentClass.rootSelector);
        var componentCombinedSelector = selector
            ? (0, utils_1.appendSelector)(componentRootSelector, selector)
            : componentRootSelector;
        var rootSelector = getRootSelector(componentCombinedSelector, this.root);
        return new MultiElementWrapper(rootSelector, function (selector) { return new ComponentClass(selector); });
    };
