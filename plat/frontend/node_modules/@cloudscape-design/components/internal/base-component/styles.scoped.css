...
:root {
  ...
  --color-charts-error-bar-marker-r10jgv:#131920;
  ...
  --color-background-badge-icon-jyxnxa:#db0000;
  --color-background-button-link-active-5oi2dp:#d1f1ff;
  --color-background-button-link-hover-lhrs2u:#f0fbff;
  --color-background-button-normal-active-5imwxd:#d1f1ff;
  --color-background-button-normal-default-7f99mv:#ffffff;
  --color-background-button-normal-disabled-hl039l:#ffffff;
  --color-background-button-normal-hover-53op9s:#f0fbff;
  --color-background-toggle-button-normal-pressed-4khex7:#d1f1ff;
  --color-background-button-primary-active-5cqoqt:#002b66;
  --color-background-button-primary-default-vdt0fu:#006ce0;
  --color-background-button-primary-disabled-sgo4zo:#ebebf0;
  --color-background-button-primary-hover-mo85i6:#002b66;
  --color-background-direction-button-active-lvo0dy:#232b37;
  --color-background-direction-button-default-bvhbsn:#424650;
  --color-background-direction-button-disabled-s9x4zq:#ebebf0;
  --color-background-direction-button-hover-74n5o1:#333843;
  --color-text-direction-button-default-p88lvb:#ffffff;
  --color-text-direction-button-disabled-2jds36:#b4b4bb;
  --color-background-calendar-current-date-sk0f6i:#f3f3f7;
  --color-background-cell-shaded-v7o6so:#f6f6f9;
  --color-background-code-editor-gutter-active-line-default-51v1pv:#656871;
  --color-background-code-editor-gutter-active-line-error-ro2qo1:#db0000;
  --color-background-code-editor-gutter-default-15qdwh:#f3f3f7;
  --color-background-code-editor-loading-6nwpin:#f9f9fa;
  --color-background-code-editor-pane-item-hover-z6k9mr:#ebebf0;
  --color-background-code-editor-status-bar-yjtxod:#f3f3f7;
  --color-background-container-content-6u8rvp:#ffffff;
  --color-background-container-header-gs3mbe:#ffffff;
  --color-background-control-checked-ka7kc2:#006ce0;
  --color-background-control-default-4jb21l:#ffffff;
  --color-background-control-disabled-1f3718:#dedee3;
  --color-background-dropdown-item-default-qmc033:#ffffff;
  --color-background-dropdown-item-dimmed-dhho03:transparent;
  --color-background-dropdown-item-filter-match-49b5vt:#f0fbff;
  --color-background-dropdown-item-hover-yunepc:#f3f3f7;
  --color-background-dropdown-item-selected-f3v6te:#f0fbff;
  --color-background-home-header-4c9jt4:#0f141a;
  --color-background-input-default-ifz5bb:#ffffff;
  --color-background-input-disabled-dihaja:#ebebf0;
  --color-background-item-selected-9gppru:#f0fbff;
  --color-background-layout-main-5ilwcb:#ffffff;
  --color-background-layout-mobile-panel-ed0ava:#0f141a;
  --color-background-layout-panel-content-xto15e:#ffffff;
  --color-background-layout-panel-hover-tguulw:#ebebf0;
  ...
  --color-background-layout-toggle-selected-active-zcl8w3:#006ce0;
  --color-background-layout-toggle-selected-default-izfana:#006ce0;
  --color-background-layout-toggle-selected-hover-7953u1:#004a9e;
  --color-background-modal-overlay-d7uby0:rgba(35, 43, 55, 0.7);
  --color-background-notification-blue-4vnob8:#006ce0;
  --color-background-notification-green-2rkyvu:#00802f;
  --color-background-notification-grey-x3vul6:#424650;
  ...
  --color-background-popover-e20fy8:#ffffff;
  --color-background-progress-bar-content-default-il6sg6:#006ce0;
  --color-background-progress-bar-content-in-flash-98s7uz:#ffffff;
  --color-background-progress-bar-layout-default-z3ipl1:#ebebf0;
  --color-background-progress-bar-layout-in-flash-wssh6k:rgba(255, 255, 255, 0.25);
  --color-background-segment-active-1u2ldl:#006ce0;
  --color-background-segment-default-b0r494:#ffffff;
  --color-background-segment-disabled-m2a5t7:#ffffff;
  --color-background-segment-hover-800sl4:#f0fbff;
  --color-background-segment-wrapper-5tudmm:#ffffff;
  --color-background-slider-handle-default-lp5ntg:#006ce0;
  --color-background-slider-handle-active-50ubqb:#004a9e;
  --color-background-slider-track-jsr5s6:#8c8c94;
  --color-background-slider-handle-ring-9sfenj:#ffffff;
  --color-background-slider-error-pressed-79f2kg:#700000;
  --color-background-slider-warning-pressed-j1qp7g:#855900;
  --color-background-status-error-mu3lcw:#fff5f5;
  --color-background-status-info-sfobba:#f0fbff;
  --color-background-dialog-2fj3uu:#f0fbff;
  --color-background-status-success-h6b8bh:#effff1;
  --color-background-status-warning-cv83up:#fffef0;
  --color-background-table-header-hdjxos:#ffffff;
  --color-background-tiles-disabled-4ynms7:#ebebf0;
  --color-background-toggle-checked-disabled-amxc0a:#b8e7ff;
  --color-background-toggle-default-kjlhv0:#424650;
  ...
  --color-background-chat-bubble-incoming-j38cew:#f6f6f9;
  --color-text-chat-bubble-outgoing-f3r63s:#0f141a;
  --color-text-chat-bubble-incoming-od0yh8:#0f141a;
  --color-border-button-normal-active-ru7yhb:#002b66;
  --color-border-button-normal-default-glqfp1:#006ce0;
  --color-border-toggle-button-normal-pressed-tq8o41:#006ce0;
  --color-border-button-normal-disabled-pkhetz:#b4b4bb;
  --color-text-button-normal-disabled-05p74s:#8c8c94;
  --color-border-button-normal-hover-6a2tdq:#002b66;
  --color-text-button-icon-disabled-nnofkn:#8c8c94;
  --color-border-button-primary-disabled-b5p1ji:#ebebf0;
  --color-text-button-primary-disabled-q79gms:#8c8c94;
  --color-border-calendar-grid-67r4w4:transparent;
  --color-border-calendar-grid-selected-focus-ring-jk1fb0:#f9f9fa;
  --color-border-cell-shaded-0ipazf:#dedee3;
  ...
  --color-border-code-editor-default-2bfcfq:#dedee3;
  --color-border-code-editor-pane-item-hover-wvblek:#8c8c94;
  --color-border-container-divider-9huz1a:transparent;
  --color-border-container-top-k3vmoz:transparent;
  --color-border-control-checked-bdv28l:#006ce0;
  --color-border-control-default-sh3548:#8c8c94;
  --color-border-control-disabled-uj7t08:#dedee3;
  --color-border-divider-active-biq3j4:#0f141a;
  --color-border-divider-default-nr68jt:#c6c6cd;
  --color-border-divider-panel-bottom-bruvuz:#c6c6cd;
  --color-border-divider-panel-side-an0w07:#c6c6cd;
  --color-border-divider-secondary-qoitch:#ebebf0;
  --color-border-dropdown-container-cmthq7:#b4b4bb;
  --color-border-dropdown-group-ylcnh8:#c6c6cd;
  --color-border-dropdown-item-default-kape37:#c6c6cd;
  --color-border-dropdown-item-hover-aqfuxq:#8c8c94;
  --color-border-dropdown-item-dimmed-hover-ga9sch:#8c8c94;
  --color-border-dropdown-item-selected-dl2ezh:#006ce0;
  --color-border-dropdown-item-top-gp2d1p:transparent;
  --color-border-editable-cell-hover-2hmo55:#8c8c94;
  --color-border-input-default-317xk5:#8c8c94;
  --color-border-input-disabled-zgnzvk:#ebebf0;
  --color-border-input-focused-4z0pgn:#006ce0;
  --color-border-item-focused-uk47pl:#006ce0;
  --color-border-dropdown-item-focused-zacqlp:#424650;
  --color-border-item-placeholder-x8kbjp:#006ce0;
  --color-border-item-selected-wl5ttm:#006ce0;
  --color-border-layout-ayg8vb:#c6c6cd;
  --color-border-notification-stack-bar-aszsse:#232b37;
  --color-border-panel-header-ygztvl:#c6c6cd;
  --color-border-popover-1ye6tz:#b4b4bb;
  --color-border-segment-active-ls9t4n:#424650;
  --color-border-segment-default-6ig2mo:#424650;
  --color-border-segment-disabled-fcrbcl:#424650;
  --color-border-segment-hover-0o9ey3:#424650;
  --color-border-status-error-j8acpp:#db0000;
  --color-border-status-info-qf6jok:#006ce0;
  --color-border-status-success-8z5f8u:#00802f;
  --color-border-status-warning-j40pg7:#855900;
  --color-border-dialog-0rjwug:#006ce0;
  --color-border-divider-interactive-default-r928dz:#8c8c94;
  --color-border-tabs-divider-f5t9va:#c6c6cd;
  --color-border-tabs-shadow-ugyo07:rgba(15, 20, 26, 0.12);
  --color-border-tabs-underline-gudemr:#006ce0;
  --color-border-tiles-disabled-19olbu:#ebebf0;
  --color-border-tutorial-zggi80:#dedee3;
  --color-foreground-control-default-eto4wy:#ffffff;
  --color-foreground-control-disabled-txi6cf:#ffffff;
  --color-foreground-control-read-only-7ydvuj:#656871;
  --color-shadow-default-o7dmmm:rgba(15, 20, 26, 0.12);
  --color-stroke-chart-line-3nsnk6:#8c8c94;
  --color-text-accent-n1kmht:#006ce0;
  --color-text-body-default-vvtq8u:#0f141a;
  --color-text-body-secondary-bcbgoi:#424650;
  --color-text-breadcrumb-current-2mqnkk:#656871;
  --color-text-breadcrumb-icon-9j48ot:#8c8c94;
  --color-text-button-inline-icon-default-f8xgpk:#006ce0;
  --color-text-button-inline-icon-disabled-82hho0:#b4b4bb;
  --color-text-button-inline-icon-hover-c08r6g:#002b66;
  --color-text-button-normal-active-vihsxh:#002b66;
  --color-text-toggle-button-normal-pressed-wnx2zl:#002b66;
  --color-text-button-normal-default-nzalii:#006ce0;
  --color-text-button-normal-hover-gusgyv:#002b66;
  --color-text-link-button-normal-default-5w3m67:#006ce0;
  --color-text-link-button-normal-hover-4awpjm:#002b66;
  --color-text-link-button-normal-active-js9ryu:#002b66;
  --color-text-button-primary-active-refmba:#ffffff;
  --color-text-button-primary-default-mwl31m:#ffffff;
  --color-text-button-primary-hover-pw12ep:#ffffff;
  --color-text-calendar-date-hover-3fcriv:#0f141a;
  --color-text-calendar-month-ea0e93:#656871;
  --color-text-code-editor-gutter-active-line-2addhd:#ffffff;
  --color-text-code-editor-gutter-default-nlshs8:#0f141a;
  --color-text-code-editor-status-bar-disabled-xxmtlc:#8c8c94;
  --color-text-code-editor-tab-button-error-avwh01:#ffffff;
  --color-text-column-header-e6urd1:#424650;
  --color-text-column-sorting-icon-fngn77:#424650;
  --color-text-control-disabled-upk9lz:#b4b4bb;
  --color-text-counter-bywf75:#656871;
  --color-text-disabled-rox5hg:#b4b4bb;
  --color-text-disabled-inline-edit-1cbiz8:#424650;
  --color-text-dropdown-footer-umcot2:#656871;
  --color-text-dropdown-group-label-2tmyik:#424650;
  --color-text-dropdown-item-default-f1jr9u:#0f141a;
  --color-text-dropdown-item-dimmed-tq8vh3:#b4b4bb;
  --color-text-dropdown-item-disabled-8m65hf:#b4b4bb;
  --color-text-dropdown-item-filter-match-ebhvct:#006ce0;
  --color-text-dropdown-item-highlighted-yr1px8:#0f141a;
  --color-text-dropdown-item-secondary-v12lfh:#656871;
  --color-text-dropdown-item-secondary-hover-de15wb:#656871;
  --color-text-empty-tlohug:#656871;
  --color-text-expandable-section-default-ynw8my:#0f141a;
  --color-text-expandable-section-hover-ojzwhd:#006ce0;
  --color-text-expandable-section-navigation-icon-default-mklu1s:#424650;
  --color-text-form-default-47mtz6:#0f141a;
  --color-text-form-label-6sbm75:#0f141a;
  --color-text-form-secondary-1nm780:#656871;
  --color-text-group-label-a2qc05:#424650;
  --color-text-label-gen-ai-a2n3od:#7300e5;
  --color-text-heading-default-izpp46:#0f141a;
  --color-text-heading-secondary-iwtvf6:#424650;
  --color-text-home-header-default-morg6i:#ebebf0;
  --color-text-home-header-secondary-i4jhp7:#c6c6cd;
  --color-text-icon-subtle-3sgxlr:#656871;
  --color-text-input-disabled-wh1f3y:#b4b4bb;
  --color-text-input-placeholder-dclg8u:#656871;
  --color-text-input-placeholder-disabled-wg87og:#b4b4bb;
  --color-text-interactive-active-uoe6zi:#0f141a;
  --color-text-interactive-default-ugh9wp:#424650;
  --color-text-interactive-disabled-1bqmrl:#b4b4bb;
  --color-text-interactive-hover-6naf7i:#0f141a;
  --color-text-toggle-button-icon-pressed-detfkz:#0f141a;
  --color-text-interactive-inverted-default-xlc0d5:#dedee3;
  --color-text-interactive-inverted-hover-65rnp7:#f9f9fa;
  --color-text-inverted-4v4dmq:#ffffff;
  --color-text-label-8248dg:#0f141a;
  --color-text-layout-toggle-1a15s3:#ffffff;
  --color-text-layout-toggle-active-ifu7qp:#ffffff;
  --color-text-layout-toggle-hover-9jwdce:#006ce0;
  --color-text-layout-toggle-selected-xpximc:#ffffff;
  --color-text-link-default-1dmm7z:#006ce0;
  --color-text-link-hover-sq1gxg:#002b66;
  ...
  --color-text-pagination-page-number-active-disabled-gfl43p:#b4b4bb;
  --color-text-pagination-page-number-default-74j15c:#424650;
  --color-text-segment-active-hlorbe:#ffffff;
  --color-text-segment-default-vi2vn9:#424650;
  --color-text-segment-hover-65a2x8:#002b66;
  --color-text-small-m1tr70:#656871;
  --color-text-status-error-ksqavh:#db0000;
  --color-text-status-inactive-gy7337:#656871;
  --color-text-status-info-ue8bd2:#006ce0;
  --color-text-status-success-ybmii8:#00802f;
  --color-text-status-warning-6meo06:#855900;
  --color-text-top-navigation-title-en0v40:#0f141a;
  --color-text-tutorial-hotspot-default-xfv3ow:#006ce0;
  --color-text-tutorial-hotspot-hover-92pxog:#002b66;
  --color-board-placeholder-active-x6yfem:#ebebf0;
  --color-board-placeholder-hover-5nov9c:#d1f1ff;
  --color-drag-placeholder-active-ea1sgp:#ebebf0;
  --color-drag-placeholder-hover-qwadna:#d1f1ff;
  --color-dropzone-background-default-7efhmb:#ffffff;
  --color-dropzone-background-hover-mi8rlm:#f0fbff;
  --color-dropzone-text-default-djdnme:#424650;
  --color-dropzone-text-hover-asw3rt:#424650;
...
@media not print {
  .awsui-dark-mode:not(#\9) {
    ...
    --color-charts-error-bar-marker-r10jgv:#ffffff;
    ...
    --color-background-badge-icon-jyxnxa:#ff7a7a;
    --color-background-button-link-active-5oi2dp:#333843;
    --color-background-button-link-hover-lhrs2u:#1b232d;
    --color-background-button-normal-active-5imwxd:#333843;
    --color-background-button-normal-default-7f99mv:#161d26;
    --color-background-button-normal-disabled-hl039l:#161d26;
    --color-background-button-normal-hover-53op9s:#1b232d;
    --color-background-toggle-button-normal-pressed-4khex7:#333843;
    --color-background-button-primary-active-5cqoqt:#42b4ff;
    --color-background-button-primary-default-vdt0fu:#42b4ff;
    --color-background-button-primary-disabled-sgo4zo:#232b37;
    --color-background-button-primary-hover-mo85i6:#75cfff;
    --color-background-direction-button-disabled-s9x4zq:#232b37;
    --color-text-direction-button-disabled-2jds36:#656871;
    --color-background-calendar-current-date-sk0f6i:#333843;
    --color-background-cell-shaded-v7o6so:#1b232d;
    --color-background-code-editor-gutter-active-line-default-51v1pv:#8c8c94;
    --color-background-code-editor-gutter-active-line-error-ro2qo1:#ff7a7a;
    --color-background-code-editor-gutter-default-15qdwh:#1b232d;
    --color-background-code-editor-loading-6nwpin:#1b232d;
    --color-background-code-editor-pane-item-hover-z6k9mr:#333843;
    --color-background-code-editor-status-bar-yjtxod:#1b232d;
    --color-background-container-content-6u8rvp:#161d26;
    --color-background-container-header-gs3mbe:#161d26;
    --color-background-control-checked-ka7kc2:#42b4ff;
    --color-background-control-default-4jb21l:#161d26;
    --color-background-control-disabled-1f3718:#333843;
    --color-background-dropdown-item-default-qmc033:#1b232d;
    --color-background-dropdown-item-filter-match-49b5vt:#333843;
    --color-background-dropdown-item-hover-yunepc:#131920;
    --color-background-dropdown-item-selected-f3v6te:#001129;
    --color-background-input-default-ifz5bb:#161d26;
    --color-background-input-disabled-dihaja:#1b232d;
    --color-background-item-selected-9gppru:#001129;
    --color-background-layout-main-5ilwcb:#161d26;
    --color-background-layout-panel-content-xto15e:#161d26;
    --color-background-layout-panel-hover-tguulw:#333843;
    --color-background-layout-toggle-selected-active-zcl8w3:#42b4ff;
    --color-background-layout-toggle-selected-default-izfana:#42b4ff;
    --color-background-layout-toggle-selected-hover-7953u1:#75cfff;
    --color-background-modal-overlay-d7uby0:rgba(15, 20, 26, 0.7);
    --color-background-notification-grey-x3vul6:#656871;
    --color-background-popover-e20fy8:#1b232d;
    --color-background-progress-bar-content-default-il6sg6:#42b4ff;
    --color-background-progress-bar-layout-default-z3ipl1:#333843;
    --color-background-segment-active-1u2ldl:#42b4ff;
    --color-background-segment-default-b0r494:#161d26;
    --color-background-segment-disabled-m2a5t7:#161d26;
    --color-background-segment-hover-800sl4:#1b232d;
    --color-background-segment-wrapper-5tudmm:#161d26;
    --color-background-slider-handle-default-lp5ntg:#42b4ff;
    --color-background-slider-handle-active-50ubqb:#75cfff;
    --color-background-slider-track-jsr5s6:#656871;
    --color-background-slider-handle-ring-9sfenj:#161d26;
    --color-background-slider-error-pressed-79f2kg:#ff7a7a;
    --color-background-slider-warning-pressed-j1qp7g:#fbd332;
    --color-background-status-error-mu3lcw:#1f0000;
    --color-background-status-info-sfobba:#001129;
    --color-background-dialog-2fj3uu:#001129;
    --color-background-status-success-h6b8bh:#001401;
    --color-background-status-warning-cv83up:#191100;
    --color-background-table-header-hdjxos:#161d26;
    --color-background-tiles-disabled-4ynms7:#1b232d;
    --color-background-toggle-checked-disabled-amxc0a:#002b66;
    --color-background-toggle-default-kjlhv0:#8c8c94;
    --color-background-chat-bubble-incoming-j38cew:#0f141a;
    --color-text-chat-bubble-outgoing-f3r63s:#c6c6cd;
    --color-text-chat-bubble-incoming-od0yh8:#c6c6cd;
    --color-border-button-normal-active-ru7yhb:#75cfff;
    --color-border-button-normal-default-glqfp1:#42b4ff;
    --color-border-toggle-button-normal-pressed-tq8o41:#42b4ff;
    --color-border-button-normal-disabled-pkhetz:#656871;
    --color-border-button-normal-hover-6a2tdq:#75cfff;
    --color-border-button-primary-disabled-b5p1ji:#232b37;
    --color-border-calendar-grid-selected-focus-ring-jk1fb0:#161d26;
    --color-border-cell-shaded-0ipazf:#333843;
    --color-border-code-editor-default-2bfcfq:#656871;
    --color-border-code-editor-pane-item-hover-wvblek:#656871;
    --color-border-control-checked-bdv28l:#42b4ff;
    --color-border-control-disabled-uj7t08:#333843;
    --color-border-divider-active-biq3j4:#f9f9fa;
    --color-border-divider-default-nr68jt:#424650;
    --color-border-divider-panel-bottom-bruvuz:#424650;
    --color-border-divider-panel-side-an0w07:#424650;
    --color-border-divider-secondary-qoitch:#232b37;
    --color-border-dropdown-container-cmthq7:#656871;
    --color-border-dropdown-group-ylcnh8:#424650;
    --color-border-dropdown-item-default-kape37:#424650;
    --color-border-dropdown-item-hover-aqfuxq:#656871;
    --color-border-dropdown-item-selected-dl2ezh:#42b4ff;
    --color-border-editable-cell-hover-2hmo55:#656871;
    --color-border-input-default-317xk5:#656871;
    --color-border-input-disabled-zgnzvk:#1b232d;
    --color-border-input-focused-4z0pgn:#42b4ff;
    --color-border-item-focused-uk47pl:#42b4ff;
    --color-border-dropdown-item-focused-zacqlp:#dedee3;
    --color-border-item-placeholder-x8kbjp:#42b4ff;
    --color-border-item-selected-wl5ttm:#42b4ff;
    --color-border-layout-ayg8vb:#424650;
    --color-border-panel-header-ygztvl:#424650;
    --color-border-popover-1ye6tz:#656871;
    --color-border-segment-active-ls9t4n:#dedee3;
    --color-border-segment-default-6ig2mo:#dedee3;
    --color-border-segment-disabled-fcrbcl:#dedee3;
    --color-border-segment-hover-0o9ey3:#dedee3;
    --color-border-status-error-j8acpp:#ff7a7a;
    --color-border-status-info-qf6jok:#42b4ff;
    --color-border-status-success-8z5f8u:#2bb534;
    --color-border-status-warning-j40pg7:#fbd332;
    --color-border-dialog-0rjwug:#42b4ff;
    --color-border-divider-interactive-default-r928dz:#dedee3;
    --color-border-tabs-divider-f5t9va:#424650;
    --color-border-tabs-shadow-ugyo07:rgba(15, 20, 26, 1);
    --color-border-tabs-underline-gudemr:#42b4ff;
    --color-border-tiles-disabled-19olbu:#1b232d;
    --color-border-tutorial-zggi80:#424650;
    --color-foreground-control-default-eto4wy:#0f141a;
    --color-foreground-control-disabled-txi6cf:#161d26;
    --color-foreground-control-read-only-7ydvuj:#a4a4ad;
    --color-shadow-default-o7dmmm:rgba(15, 20, 26, 1);
    --color-text-accent-n1kmht:#42b4ff;
    --color-text-body-default-vvtq8u:#c6c6cd;
    --color-text-body-secondary-bcbgoi:#c6c6cd;
    --color-text-breadcrumb-current-2mqnkk:#8c8c94;
    --color-text-breadcrumb-icon-9j48ot:#656871;
    --color-text-button-inline-icon-default-f8xgpk:#42b4ff;
    --color-text-button-inline-icon-disabled-82hho0:#656871;
    --color-text-button-inline-icon-hover-c08r6g:#75cfff;
    --color-text-button-normal-active-vihsxh:#75cfff;
    --color-text-toggle-button-normal-pressed-wnx2zl:#75cfff;
    --color-text-button-normal-default-nzalii:#42b4ff;
    --color-text-button-normal-hover-gusgyv:#75cfff;
    --color-text-link-button-normal-default-5w3m67:#42b4ff;
    --color-text-link-button-normal-hover-4awpjm:#75cfff;
    --color-text-link-button-normal-active-js9ryu:#75cfff;
    --color-text-button-primary-active-refmba:#0f141a;
    --color-text-button-primary-default-mwl31m:#0f141a;
    --color-text-button-primary-hover-pw12ep:#0f141a;
    --color-text-calendar-date-hover-3fcriv:#dedee3;
    --color-text-calendar-month-ea0e93:#a4a4ad;
    --color-text-code-editor-gutter-active-line-2addhd:#0f141a;
    --color-text-code-editor-gutter-default-nlshs8:#dedee3;
    --color-text-code-editor-status-bar-disabled-xxmtlc:#656871;
    --color-text-code-editor-tab-button-error-avwh01:#0f141a;
    --color-text-column-header-e6urd1:#b4b4bb;
    --color-text-column-sorting-icon-fngn77:#b4b4bb;
    --color-text-control-disabled-upk9lz:#656871;
    --color-text-counter-bywf75:#a4a4ad;
    --color-text-disabled-rox5hg:#656871;
    --color-text-disabled-inline-edit-1cbiz8:#b4b4bb;
    --color-text-dropdown-footer-umcot2:#a4a4ad;
    --color-text-dropdown-group-label-2tmyik:#c6c6cd;
    --color-text-dropdown-item-default-f1jr9u:#dedee3;
    --color-text-dropdown-item-dimmed-tq8vh3:#656871;
    --color-text-dropdown-item-disabled-8m65hf:#656871;
    --color-text-dropdown-item-filter-match-ebhvct:#75cfff;
    --color-text-dropdown-item-highlighted-yr1px8:#ebebf0;
    --color-text-dropdown-item-secondary-v12lfh:#a4a4ad;
    --color-text-dropdown-item-secondary-hover-de15wb:#dedee3;
    --color-text-empty-tlohug:#dedee3;
    --color-text-expandable-section-default-ynw8my:#dedee3;
    --color-text-expandable-section-hover-ojzwhd:#42b4ff;
    --color-text-expandable-section-navigation-icon-default-mklu1s:#dedee3;
    --color-text-form-default-47mtz6:#dedee3;
    --color-text-form-label-6sbm75:#dedee3;
    --color-text-form-secondary-1nm780:#a4a4ad;
    --color-text-group-label-a2qc05:#c6c6cd;
    --color-text-label-gen-ai-a2n3od:#bf80ff;
    --color-text-heading-default-izpp46:#ebebf0;
    --color-text-heading-secondary-iwtvf6:#a4a4ad;
    --color-text-icon-subtle-3sgxlr:#b4b4bb;
    --color-text-input-disabled-wh1f3y:#656871;
    --color-text-input-placeholder-dclg8u:#a4a4ad;
    --color-text-input-placeholder-disabled-wg87og:#656871;
    --color-text-interactive-active-uoe6zi:#f9f9fa;
    --color-text-interactive-default-ugh9wp:#dedee3;
    --color-text-interactive-disabled-1bqmrl:#656871;
    --color-text-interactive-hover-6naf7i:#f9f9fa;
    --color-text-toggle-button-icon-pressed-detfkz:#f9f9fa;
    --color-text-inverted-4v4dmq:#0f141a;
    --color-text-label-8248dg:#dedee3;
    --color-text-layout-toggle-active-ifu7qp:#161d26;
    --color-text-layout-toggle-hover-9jwdce:#42b4ff;
    --color-text-layout-toggle-selected-xpximc:#0f141a;
    --color-text-link-default-1dmm7z:#42b4ff;
    --color-text-link-hover-sq1gxg:#75cfff;
    --color-text-pagination-page-number-active-disabled-gfl43p:#656871;
    --color-text-pagination-page-number-default-74j15c:#b4b4bb;
    --color-text-segment-active-hlorbe:#0f141a;
    --color-text-segment-default-vi2vn9:#dedee3;
    --color-text-segment-hover-65a2x8:#75cfff;
    --color-text-small-m1tr70:#a4a4ad;
    --color-text-status-error-ksqavh:#ff7a7a;
    --color-text-status-inactive-gy7337:#a4a4ad;
    --color-text-status-info-ue8bd2:#42b4ff;
    --color-text-status-success-ybmii8:#2bb534;
    --color-text-status-warning-6meo06:#fbd332;
    --color-text-top-navigation-title-en0v40:#f9f9fa;
    --color-text-tutorial-hotspot-default-xfv3ow:#42b4ff;
    --color-text-tutorial-hotspot-hover-92pxog:#75cfff;
    --color-board-placeholder-active-x6yfem:#656871;
    --color-board-placeholder-hover-5nov9c:#006ce0;
    --color-drag-placeholder-active-ea1sgp:#656871;
    --color-drag-placeholder-hover-qwadna:#006ce0;
    --color-dropzone-background-default-7efhmb:#161d26;
    --color-dropzone-background-hover-mi8rlm:#001129;
    --color-dropzone-text-default-djdnme:#c6c6cd;
    --color-dropzone-text-hover-asw3rt:#c6c6cd;
...
.awsui-context-top-navigation:not(#\9) {
  ...
  --color-background-control-default-4jb21l:#161d26;
  --color-background-control-disabled-1f3718:#333843;
  --color-background-dropdown-item-default-qmc033:#161d26;
  --color-background-dropdown-item-filter-match-49b5vt:#333843;
  --color-background-dropdown-item-hover-yunepc:#131920;
  --color-background-dropdown-item-selected-f3v6te:#001129;
  --color-background-input-default-ifz5bb:#161d26;
...
.awsui-context-content-header:not(#\9) {
  ...
  --color-background-button-link-hover-lhrs2u:#1b232d;
  --color-background-button-normal-active-5imwxd:#333843;
  --color-background-button-normal-default-7f99mv:#0f141a;
  --color-background-button-normal-disabled-hl039l:#0f141a;
  --color-background-button-normal-hover-53op9s:#1b232d;
  --color-background-toggle-button-normal-pressed-4khex7:#333843;
  --color-background-button-primary-active-5cqoqt:#42b4ff;
  --color-background-button-primary-default-vdt0fu:#42b4ff;
  ...
  --color-background-container-header-gs3mbe:#161d26;
  --color-background-control-checked-ka7kc2:#42b4ff;
  --color-background-control-default-4jb21l:#0f141a;
  --color-background-control-disabled-1f3718:#333843;
  --color-background-dropdown-item-default-qmc033:#1b232d;
  --color-background-dropdown-item-filter-match-49b5vt:#333843;
  --color-background-dropdown-item-hover-yunepc:#131920;
  --color-background-dropdown-item-selected-f3v6te:#001129;
  --color-background-input-default-ifz5bb:#0f141a;
  --color-background-input-disabled-dihaja:#1b232d;
  --color-background-item-selected-9gppru:#001129;
  --color-background-layout-main-5ilwcb:#0f141a;
  --color-background-layout-panel-content-xto15e:#161d26;
  --color-background-layout-panel-hover-tguulw:#333843;
  --color-background-layout-toggle-selected-active-zcl8w3:#42b4ff;
  --color-background-layout-toggle-selected-default-izfana:#42b4ff;
  ...
  --color-background-progress-bar-layout-default-z3ipl1:#333843;
  --color-background-segment-active-1u2ldl:#42b4ff;
  --color-background-segment-default-b0r494:#0f141a;
  --color-background-segment-disabled-m2a5t7:#0f141a;
  --color-background-segment-hover-800sl4:#1b232d;
  --color-background-segment-wrapper-5tudmm:#0f141a;
  --color-background-slider-handle-default-lp5ntg:#42b4ff;
  --color-background-slider-handle-active-50ubqb:#75cfff;
  --color-background-slider-track-jsr5s6:#656871;
  --color-background-slider-handle-ring-9sfenj:#161d26;
  ...
  --color-background-status-success-h6b8bh:#001401;
  --color-background-status-warning-cv83up:#191100;
  --color-background-table-header-hdjxos:#0f141a;
  --color-background-tiles-disabled-4ynms7:#1b232d;
  --color-background-toggle-checked-disabled-amxc0a:#002b66;
  --color-background-toggle-default-kjlhv0:#8c8c94;
  --color-background-chat-bubble-incoming-j38cew:#0f141a;
...
.awsui-context-flashbar:not(#\9) {
  ...
  --color-background-button-primary-default-vdt0fu:#f9f9fa;
  --color-background-button-primary-hover-mo85i6:#ffffff;
  --color-background-segment-default-b0r494:transparent;
  --color-background-segment-hover-800sl4:rgba(0, 7, 22, 0.15);
  --color-text-chat-bubble-outgoing-f3r63s:#f9f9fa;
  --color-text-chat-bubble-incoming-od0yh8:#f9f9fa;
  --color-border-button-normal-active-ru7yhb:#ffffff;
  --color-border-button-normal-default-glqfp1:#f9f9fa;
  --color-border-button-normal-hover-6a2tdq:#ffffff;
  --color-border-divider-default-nr68jt:#f9f9fa;
  --color-border-divider-panel-bottom-bruvuz:#f9f9fa;
  --color-border-divider-panel-side-an0w07:#f9f9fa;
  --color-border-dropdown-group-ylcnh8:#f9f9fa;
  --color-border-dropdown-item-default-kape37:#f9f9fa;
  --color-border-item-focused-uk47pl:#f9f9fa;
  --color-border-panel-header-ygztvl:#f9f9fa;
  --color-text-body-default-vvtq8u:#f9f9fa;
  --color-text-button-normal-active-vihsxh:#ffffff;
  --color-text-button-normal-default-nzalii:#f9f9fa;
  --color-text-button-normal-hover-gusgyv:#ffffff;
  --color-text-link-button-normal-default-5w3m67:#f9f9fa;
  --color-text-link-button-normal-hover-4awpjm:#ffffff;
  --color-text-link-button-normal-active-js9ryu:#ffffff;
  --color-text-expandable-section-default-ynw8my:#f9f9fa;
  --color-text-expandable-section-hover-ojzwhd:#ffffff;
  --color-text-heading-secondary-iwtvf6:#f9f9fa;
  --color-text-segment-hover-65a2x8:#ffffff;
  --color-text-tutorial-hotspot-default-xfv3ow:#dedee3;
  --color-text-tutorial-hotspot-hover-92pxog:#f9f9fa;
}
...
.awsui-context-flashbar-warning:not(#\9) {
  ...
  --color-background-button-primary-default-vdt0fu:#424650;
  --color-background-button-primary-hover-mo85i6:#0f141a;
  ...
  --color-background-segment-default-b0r494:transparent;
  --color-background-segment-hover-800sl4:rgba(0, 7, 22, 0.05);
  --color-border-button-normal-active-ru7yhb:#0f141a;
  --color-border-button-normal-default-glqfp1:#424650;
  --color-border-button-normal-hover-6a2tdq:#0f141a;
  --color-border-divider-default-nr68jt:#0f141a;
  --color-border-divider-panel-bottom-bruvuz:#0f141a;
  --color-border-divider-panel-side-an0w07:#0f141a;
  --color-border-dropdown-group-ylcnh8:#0f141a;
  --color-border-dropdown-item-default-kape37:#0f141a;
  --color-border-item-focused-uk47pl:#0f141a;
  --color-border-panel-header-ygztvl:#0f141a;
  --color-text-button-normal-active-vihsxh:#0f141a;
  --color-text-button-normal-default-nzalii:#424650;
  --color-text-button-normal-hover-gusgyv:#0f141a;
  --color-text-link-button-normal-active-js9ryu:#0f141a;
  --color-text-expandable-section-hover-ojzwhd:#0f141a;
  --color-text-heading-secondary-iwtvf6:#0f141a;
  ...
  --color-text-segment-hover-65a2x8:#0f141a;
  --color-text-tutorial-hotspot-default-xfv3ow:#656871;
  --color-text-tutorial-hotspot-hover-92pxog:#131920;
}
...
.awsui-context-alert:not(#\9) {
  ...
  --color-text-button-normal-hover-gusgyv:#0f141a;
  --color-text-link-button-normal-active-js9ryu:#0f141a;
  --color-text-expandable-section-default-ynw8my:#424650;
  --color-text-expandable-section-hover-ojzwhd:#0f141a;
  --color-text-segment-hover-65a2x8:#0f141a;
...
.awsui-context-content-header .awsui-context-alert:not(#\9) {
  ...
  --color-background-toggle-button-normal-pressed-4khex7:#333843;
  --color-background-button-primary-active-5cqoqt:#42b4ff;
  --color-background-button-primary-default-vdt0fu:#dedee3;
  --color-background-button-primary-disabled-sgo4zo:#232b37;
  --color-background-button-primary-hover-mo85i6:#ffffff;
  --color-background-direction-button-disabled-s9x4zq:#232b37;
  --color-text-direction-button-disabled-2jds36:#656871;
  ...
  --color-background-segment-default-b0r494:transparent;
  --color-background-segment-disabled-m2a5t7:#161d26;
  --color-background-segment-hover-800sl4:rgba(255, 255, 255, 0.1);
  --color-background-segment-wrapper-5tudmm:#161d26;
  --color-background-slider-handle-default-lp5ntg:#42b4ff;
  --color-background-slider-handle-active-50ubqb:#75cfff;
  --color-background-slider-track-jsr5s6:#656871;
  ...
  --color-text-chat-bubble-incoming-od0yh8:#c6c6cd;
  --color-border-button-normal-active-ru7yhb:#ffffff;
  --color-border-button-normal-default-glqfp1:#dedee3;
  --color-border-toggle-button-normal-pressed-tq8o41:#42b4ff;
  --color-border-button-normal-disabled-pkhetz:#656871;
  --color-border-button-normal-hover-6a2tdq:#ffffff;
  --color-border-button-primary-disabled-b5p1ji:#232b37;
  ...
  --color-border-control-disabled-uj7t08:#333843;
  --color-border-divider-active-biq3j4:#f9f9fa;
  --color-border-divider-default-nr68jt:#dedee3;
  --color-border-divider-panel-bottom-bruvuz:#dedee3;
  --color-border-divider-panel-side-an0w07:#dedee3;
  --color-border-divider-secondary-qoitch:#232b37;
  --color-border-dropdown-container-cmthq7:#656871;
  --color-border-dropdown-group-ylcnh8:#dedee3;
  --color-border-dropdown-item-default-kape37:#dedee3;
  --color-border-dropdown-item-hover-aqfuxq:#656871;
  --color-border-dropdown-item-selected-dl2ezh:#42b4ff;
  --color-border-editable-cell-hover-2hmo55:#656871;
  --color-border-input-default-317xk5:#656871;
  ...
  --color-border-item-selected-wl5ttm:#42b4ff;
  --color-border-layout-ayg8vb:#424650;
  --color-border-panel-header-ygztvl:#dedee3;
  --color-border-popover-1ye6tz:#656871;
  --color-border-segment-active-ls9t4n:#dedee3;
  --color-border-segment-default-6ig2mo:#dedee3;
  --color-border-segment-disabled-fcrbcl:#dedee3;
  ...
  --color-text-button-normal-active-vihsxh:#ffffff;
  --color-text-toggle-button-normal-pressed-wnx2zl:#75cfff;
  --color-text-button-normal-default-nzalii:#dedee3;
  --color-text-button-normal-hover-gusgyv:#ffffff;
  --color-text-link-button-normal-default-5w3m67:#42b4ff;
  --color-text-link-button-normal-hover-4awpjm:#75cfff;
  --color-text-link-button-normal-active-js9ryu:#ffffff;
...
.awsui-context-app-layout-toolbar:not(#\9) {
  --color-background-layout-main-5ilwcb:#fcfcfd;
}
...
@media not print {
  .awsui-dark-mode .awsui-context-app-layout-toolbar:not(#\9) {
    --color-background-layout-main-5ilwcb:#131920;
  }
}
@media not print {
...
:root {
  --awsui-version-info-25710725: true;
}