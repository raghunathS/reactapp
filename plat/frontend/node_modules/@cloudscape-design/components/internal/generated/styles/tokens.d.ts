...
export const colorGrey250: string;
...
export const colorGrey1000: string;
...
export const colorSeverityYellow: string;
export const colorSeverityGrey: string;
...
export const colorDropzoneBackgroundDefault: string;
export const colorDropzoneBackgroundHover: string;
export const colorDropzoneTextDefault: string;
