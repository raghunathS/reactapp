...
export interface InputProps extends BaseComponentProps, BaseInputProps, InputKeyEvents, InputAutoCorrect, InputAutoComplete, InputSpellcheck, InputClearLabel, FormFieldValidationControlProps {
  /**
