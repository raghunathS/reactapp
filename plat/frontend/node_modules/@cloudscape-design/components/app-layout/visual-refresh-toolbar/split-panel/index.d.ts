...
export declare function AppLayoutSplitPanelDrawerSideImplementation({
  children,
  appLayoutInternals,
  splitPanelInternals
}: AppLayoutSplitPanelDrawerSideImplementationProps): JSX.Element;
interface AppLayoutSplitPanelDrawerBottomImplementationProps {
  appLayoutInternals: AppLayoutInternals;
  splitPanelInternals: SplitPanelProviderProps;
  children: React.ReactNode;
}
export declare function AppLayoutSplitPanelDrawerBottomImplementation({
  children,
  splitPanelInternals,
  appLayoutInternals
}: AppLayoutSplitPanelDrawerBottomImplementationProps): JSX.Element;
