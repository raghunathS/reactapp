...
var useId = (_a = import_react.default.useId) !== null && _a !== void 0 ? _a : useRandomId;
...
function createSingletonState({ factory, initialState }) {
  ...
  return function useSingletonState() {
    const [state, setState] = (0, import_react6.useState)(value);
...
function useCurrentMode(elementRef) {
  const [value, setValue] = (0, import_react7.useState)("light");
...
function useDensityMode(elementRef) {
  const [value, setValue] = (0, import_react7.useState)("comfortable");
  useMutationObserver(elementRef, (node) => {
...
var SingleTabStopNavigationProvider = (0, import_react9.forwardRef)(({ navigationActive, children, getNextFocusTarget, isElementSuppressed, onRegisterFocusable, onUnregisterActive }, ref) => {
  ...
  return import_react9.default.createElement(SingleTabStopNavigationContext.Provider, { value: { navigationActive, registerFocusable } }, children);
});
...
//# sourceMappingURL=chunk-SMWX7PPB.js.map
