...
var Density;
(function(Density2) {
  Density2["Comfortable"] = "comfortable";
  Density2["Compact"] = "compact";
})(Density || (Density = {}));
function hasValue(allValues, mode) {
  return Object.keys(allValues).some(function(key) {
    return allValues[key] === mode;
  });
}
...
//# sourceMappingURL=@cloudscape-design_global-styles.js.map
