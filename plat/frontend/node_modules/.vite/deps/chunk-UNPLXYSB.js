...
function flattenChildren(children, depth, keys) {
  ...
  return import_react.Children.toArray(children).reduce(function(acc, node, nodeIndex) {
...
// node_modules/@cloudscape-design/components/space-between/internal.js
var InternalSpaceBetween = (0, import_react2.forwardRef)((_a, ref) => {
  ...
  return import_react2.default.createElement("div", Object.assign({}, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default.root, styles_css_default[direction], styles_css_default[`${direction}-${size}`], alignItems && styles_css_default[`align-${alignItems}`]), ref: mergedRef }), flattenedChildren.map((child) => {
    const key = typeof child === "object" ? child.key : void 0;
    return import_react2.default.createElement("div", { key, className: styles_css_default.child }, child);
  }));
});
...
//# sourceMappingURL=chunk-UNPLXYSB.js.map
