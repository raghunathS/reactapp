...
function VisualContext({ contextName, className, children }) {
  return import_react2.default.createElement("div", { className: clsx_m_default(getVisualContextClassname(contextName), className) }, children);
}
...
function useScrollSync(refs) {
  const activeElement = (0, import_react5.useRef)(null);
  return (event) => {
...
function useTableInteractionMetrics({ elementRef, items, itemCount, instanceIdentifier, getComponentIdentifier, getComponentConfiguration, loading = false, interactionMetadata }) {
  ...
  const lastUserAction = (0, import_react6.useRef)(null);
  const capturedUserAction = (0, import_react6.useRef)(null);
  const loadingStartTime = (0, import_react6.useRef)(null);
  const metadata = (0, import_react6.useRef)({ itemCount, getComponentIdentifier, getComponentConfiguration, interactionMetadata });
...
function useClickAway(onClick) {
  const awayRef = (0, import_react7.useRef)(null);
...
function ExpandToggleButton({ isExpanded, onExpandableItemToggle, expandButtonLabel, collapseButtonLabel, customIcon }) {
  ...
  return import_react8.default.createElement("button", { type: "button", ref: buttonRef, tabIndex, "aria-label": isExpanded ? collapseButtonLabel : expandButtonLabel, "aria-expanded": isExpanded, className: styles_css_default3["expand-toggle"], onClick: onExpandableItemToggle }, customIcon !== null && customIcon !== void 0 ? customIcon : import_react8.default.createElement(internal_default, { size: "small", name: "caret-down-filled", className: clsx_m_default(styles_css_default3["expand-toggle-icon"], isExpanded && styles_css_default3["expand-toggle-icon-expanded"]) }));
}
...
function useSelector(store, selector) {
  const [state, setState] = (0, import_react9.useState)(selector(store.get()));
...
function useStickyColumns({ visibleColumns, stickyColumnsFirst, stickyColumnsLast }) {
  const store = (0, import_react10.useMemo)(() => new StickyColumnsStore(), []);
  const wrapperRef = (0, import_react10.useRef)(null);
  const tableRef = (0, import_react10.useRef)(null);
  const cellsRef = (0, import_react10.useRef)(/* @__PURE__ */ new Map());
  ...
  const setWrapper = (0, import_react10.useCallback)((node) => {
    if (wrapperRef.current) {
  ...
  const setTable = (0, import_react10.useCallback)((node) => {
    tableRef.current = node;
  }, []);
  const setCell = (0, import_react10.useCallback)((columnId, node) => {
    if (node) {
...
function useStickyCellStyles({ stickyColumns, columnId, getClassName }) {
  ...
  const unsubscribeRef = (0, import_react10.useRef)(null);
  const refCallback = (0, import_react10.useCallback)(
    (cellElement) => {
...
function GridNavigationProvider({ keyboardNavigation, pageSize, getTable, children }) {
  const navigationAPI = (0, import_react11.useRef)(null);
  const gridNavigation = (0, import_react12.useMemo)(() => new GridNavigationProcessor(navigationAPI), []);
  ...
  return import_react11.default.createElement(SingleTabStopNavigationProvider, { ref: navigationAPI, navigationActive: keyboardNavigation, getNextFocusTarget: gridNavigation.getNextFocusTarget, isElementSuppressed: gridNavigation.isElementSuppressed, onRegisterFocusable: gridNavigation.onRegisterFocusable, onUnregisterActive: gridNavigation.onUnregisterActive }, children);
}
...
// node_modules/@cloudscape-design/components/table/body-cell/td-element.js
var TableTdElement = import_react13.default.forwardRef((_a, ref) => {
  ...
  return import_react13.default.createElement(
    ...
    level !== void 0 && isExpandable && !isEditingActive && import_react13.default.createElement(
      "div",
      { className: styles_css_default5["expandable-toggle-wrapper"] },
      import_react13.default.createElement(ExpandToggleButton, { isExpanded, onExpandableItemToggle, expandButtonLabel, collapseButtonLabel })
    ),
    import_react13.default.createElement("div", { className: clsx_m_default(styles_css_default5["body-cell-content"], wrapLines && styles_css_default5["body-cell-wrap"]) }, children)
  );
});
      ...
      import_react14.default.createElement(
        ...
        import_react14.default.createElement(
          ...
          import_react14.default.createElement(
            ...
            import_react14.default.createElement(internal_default, { name: "lock-private", variant: "normal", __internalRootRef: iconRef })
          ),
          descriptionEl
        )
      )
    ),
    isEditing && import_react14.default.createElement(
      "span",
      { ref: portalRef },
      import_react14.default.createElement(
        Portal,
        ...
        import_react14.default.createElement(
          ...
          import_react14.default.createElement(
            PopoverContainer,
            { size: "medium", fixedWidth: false, position: "top", trackRef: iconRef, arrow: (position) => import_react14.default.createElement(arrow_default, { position }), renderWithPortal: true, zIndex: 7e3 },
            import_react14.default.createElement(
              PopoverBody,
              { dismissButton: false, dismissAriaLabel: void 0, header: null, onDismiss: () => {
              }, overflowVisible: "both" },
              import_react14.default.createElement(internal_default2, { tagName: "span" }, editDisabledReason)
            )
          )
        )
      )
...
// node_modules/@cloudscape-design/components/grid/internal.js
var InternalGrid = import_react15.default.forwardRef((_a, ref) => {
  ...
  return import_react15.default.createElement(Tag, Object.assign({}, baseProps, { className: clsx_m_default(styles_css_default6.grid, baseProps.className, { [styles_css_default6["no-gutters"]]: disableGutters }, __responsiveClassName ? __responsiveClassName(defaultBreakpoint) : null), ref: mergedRef }), flattenedChildren.map((child, i) => {
    var _a2, _b, _c, _d;
    const key = child.key;
    return import_react15.default.createElement(
      ...
      import_react15.default.createElement("div", { className: styles_css_default6["restore-pointer-events"] }, child)
    );
  }));
});
    ...
    import_react16.default.createElement(
      ...
      import_react16.default.createElement(
        ...
        import_react16.default.createElement(
          ...
          import_react16.default.createElement(internal_default, { name: "status-negative", size: "small", ariaLabel: i18nErrorIconAriaLabel })
        )
      ),
      import_react16.default.createElement("span", { className: styles_css_default8.error__message, ref: contentRef }, children)
    ),
    import_react16.default.createElement(internal_default2, { assertive: true, tagName: "span", sources: [i18nErrorIconAriaLabel, contentRef] })
  );
}
    ...
    import_react16.default.createElement(
      ...
      import_react16.default.createElement(
        ...
        import_react16.default.createElement(
          ...
          import_react16.default.createElement(internal_default, { name: "status-warning", size: "small", ariaLabel: i18nWarningIconAriaLabel })
        )
      ),
      import_react16.default.createElement("span", { className: styles_css_default8.warning__message, ref: contentRef }, children)
    ),
    import_react16.default.createElement(internal_default2, { assertive: true, tagName: "span", sources: [i18nWarningIconAriaLabel, contentRef] })
  );
}
function ConstraintText({ id, hasValidationText, children }) {
  return import_react16.default.createElement("div", { id, className: clsx_m_default(styles_css_default8.constraint, hasValidationText && styles_css_default8["constraint-has-validation-text"]) }, children);
}
function InternalFormField(_a) {
  ...
  return import_react16.default.createElement(
    ...
    import_react16.default.createElement(
      ...
      label && import_react16.default.createElement("label", { className: clsx_m_default(styles_css_default8.label, styles_css_default7.label), id: slotIds.label, htmlFor: generatedControlId }, label),
      import_react16.default.createElement(InfoLinkLabelContext.Provider, { value: slotIds.label }, !__hideLabel && info && import_react16.default.createElement("span", { className: styles_css_default8.info }, info))
    ),
    description && import_react16.default.createElement("div", { className: styles_css_default8.description, id: slotIds.description }, description),
    import_react16.default.createElement(
      "div",
      ...
      import_react16.default.createElement(
        ...
        import_react16.default.createElement(FormFieldContext.Provider, { value: Object.assign({ controlId: generatedControlId }, contextValuesWithoutControlId) }, children && import_react16.default.createElement("div", { className: styles_css_default8.control }, children)),
        secondaryControl && import_react16.default.createElement(
          FormFieldContext.Provider,
          { value: contextValuesWithoutControlId },
          import_react16.default.createElement("div", { className: styles_css_default8["secondary-control"] }, secondaryControl)
        )
      )
    ),
    (constraintText || errorText || warningText) && import_react16.default.createElement(
      "div",
      { className: styles_css_default8.hints },
      errorText && import_react16.default.createElement(FormFieldError, { id: slotIds.error, errorIconAriaLabel: i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.errorIconAriaLabel }, errorText),
      showWarning && import_react16.default.createElement(FormFieldWarning, { id: slotIds.warning, warningIconAriaLabel: i18nStrings === null || i18nStrings === void 0 ? void 0 : i18nStrings.warningIconAriaLabel }, warningText),
      constraintText && import_react16.default.createElement(ConstraintText, { id: slotIds.constraint, hasValidationText: !!errorText || !!warningText }, constraintText)
    )
  );
}
...
function InlineEditor({ ariaLabels, item, column, onEditEnd, submitEdit, __onRender }) {
  var _a, _b, _c, _d;
  const [currentEditLoading, setCurrentEditLoading] = (0, import_react17.useState)(false);
  const [currentEditValue, setCurrentEditValue] = (0, import_react17.useState)();
  const i18n = useInternalI18n("table");
  const focusLockRef = (0, import_react17.useRef)(null);
      ...
      import_react17.default.createElement(
        ...
        import_react17.default.createElement(
          ...
          import_react17.default.createElement(
            ...
            import_react17.default.createElement("div", { className: styles_css_default5["body-cell-editor-row-editor"] }, editingCell(item, cellContext)),
            import_react17.default.createElement(
              "span",
              ...
              import_react17.default.createElement(
                ...
                !currentEditLoading ? import_react17.default.createElement(internal_default3, { ariaLabel: (_b = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.cancelEditLabel) === null || _b === void 0 ? void 0 : _b.call(ariaLabels, column), formAction: "none", iconName: "close", variant: "inline-icon", onClick: () => onCancel() }) : null,
                import_react17.default.createElement(internal_default3, { ariaLabel: (_c = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.submitEditLabel) === null || _c === void 0 ? void 0 : _c.call(ariaLabels, column), formAction: disableNativeForm ? "none" : "submit", onClick: disableNativeForm ? handleSubmit : void 0, iconName: "check", variant: "inline-icon", loading: currentEditLoading })
              ),
              import_react17.default.createElement(internal_default2, { tagName: "span", hidden: true }, currentEditLoading ? i18n("ariaLabels.submittingEditText", (_d = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.submittingEditText) === null || _d === void 0 ? void 0 : _d.call(ariaLabels, column)) : "")
            )
          )
        )
      )
...
function TableCellEditable(_a) {
  ...
  const i18n = useInternalI18n("table");
  const editActivateRef = (0, import_react18.useRef)(null);
  const tdNativeAttributes = {
    "data-inline-editing-active": isEditing.toString()
  };
  const isFocusMoveNeededRef = (0, import_react18.useRef)(false);
  const isExpandableColumn = rest.level !== void 0;
  ...
  const [hasFocus, setHasFocus] = (0, import_react18.useState)(false);
  const prevSuccessfulEdit = usePrevious(successfulEdit);
  const prevHasFocus = usePrevious(hasFocus);
  const [showSuccessIcon, setShowSuccessIcon] = (0, import_react18.useState)(false);
  (0, import_react18.useEffect)(() => {
  ...
  return import_react18.default.createElement(TableTdElement, Object.assign({}, rest, { nativeAttributes: tdNativeAttributes, isEditing, hasSuccessIcon: showSuccessIcon && hasFocus, onClick: !isEditing && !isExpandableColumn ? onEditStart : void 0, onFocus: () => setHasFocus(true), onBlur: () => setHasFocus(false) }), isEditing && column.editConfig ? import_react18.default.createElement(InlineEditor, { ariaLabels, column, item, onEditEnd: (options) => {
    setShowSuccessIcon(false);
    isFocusMoveNeededRef.current = options.refocusCell;
    onEditEnd(options.cancelled);
  }, submitEdit: submitEdit !== null && submitEdit !== void 0 ? submitEdit : submitHandlerFallback }) : import_react18.default.createElement(
    import_react18.default.Fragment,
    null,
    column.cell(item),
    showSuccessIcon && hasFocus && import_react18.default.createElement(
      import_react18.default.Fragment,
      null,
      import_react18.default.createElement(
        ...
        import_react18.default.createElement(internal_default, { name: "status-positive", variant: "success", ariaLabel: (_b = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.successfulEditLabel) === null || _b === void 0 ? void 0 : _b.call(ariaLabels, column) })
      ),
      import_react18.default.createElement(internal_default2, { tagName: "span", hidden: true }, i18n("ariaLabels.successfulEditLabel", (_c = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.successfulEditLabel) === null || _c === void 0 ? void 0 : _c.call(ariaLabels, column)))
    ),
    import_react18.default.createElement(
      "div",
      { className: styles_css_default5["body-cell-editor-wrapper"] },
      import_react18.default.createElement(
        ...
        import_react18.default.createElement(
          "span",
          { className: styles_css_default5["body-cell-editor-icon"] },
          import_react18.default.createElement(internal_default, { name: "edit" })
        )
      )
    )
  ));
...
function TableBodyCell(props) {
  ...
  if (editDisabledReason) {
    return import_react18.default.createElement(DisabledInlineEditor, Object.assign({ editDisabledReason }, props));
  }
  if (props.isEditable || props.isEditing) {
    return import_react18.default.createElement(TableCellEditable, Object.assign({}, props));
  }
  const { column, item } = props;
  return import_react18.default.createElement(TableTdElement, Object.assign({}, props, { isEditable: false }), column.cell(item));
}
...
// node_modules/@cloudscape-design/components/status-indicator/internal.js
var typeToIcon = (size) => ({
  error: import_react19.default.createElement(internal_default, { name: "status-negative", size }),
  warning: import_react19.default.createElement(internal_default, { name: "status-warning", size }),
  success: import_react19.default.createElement(internal_default, { name: "status-positive", size }),
  info: import_react19.default.createElement(internal_default, { name: "status-info", size }),
  stopped: import_react19.default.createElement(internal_default, { name: "status-stopped", size }),
  pending: import_react19.default.createElement(internal_default, { name: "status-pending", size }),
  "in-progress": import_react19.default.createElement(internal_default, { name: "status-in-progress", size }),
  loading: import_react19.default.createElement(InternalSpinner, null)
});
  ...
  return import_react19.default.createElement(
    ...
    import_react19.default.createElement(
      ...
      import_react19.default.createElement(
        ...
        __display === "inline" && import_react19.default.createElement(import_react19.default.Fragment, null, " ")
      ),
      children
    )
  );
...
function NoDataCell({ totalColumnsCount, hasFooter, loading, loadingText, empty, tableRef, containerRef }) {
  const cellContentRef = (0, import_react20.useRef)(null);
  ...
  return import_react20.default.createElement(
    ...
    import_react20.default.createElement("div", { ref: cellContentRef, className: styles_css_default4["cell-merged-content"], "data-awsui-table-suppress-navigation": true }, loading ? import_react20.default.createElement(
      StatusIndicator,
      { type: "loading", className: styles_css_default4.loading, wrapText: true },
      import_react20.default.createElement(internal_default2, { tagName: "span" }, loadingText)
    ) : import_react20.default.createElement("div", { className: styles_css_default4.empty }, empty))
  );
}
...
function ItemsLoader({ item, trackBy, children }) {
  ...
  return import_react21.default.createElement("div", { "data-root": item ? "false" : "true", "data-parentrow": parentTrackId, className: styles_css_default10["items-loader"] }, children);
}
function getLoaderContent({ item, loadingStatus, renderLoaderPending, renderLoaderLoading, renderLoaderError, renderLoaderEmpty }) {
  ...
  if (loadingStatus === "pending" && renderLoaderPending) {
    ...
    content = import_react21.default.createElement(internal_default2, { tagName: "span" }, renderLoaderLoading({ item }));
  } else if (loadingStatus === "error" && renderLoaderError) {
    content = import_react21.default.createElement(internal_default2, { tagName: "span" }, renderLoaderError({ item }));
  } else if (loadingStatus === "finished" && renderLoaderEmpty && item) {
    content = import_react21.default.createElement(internal_default2, { tagName: "span" }, renderLoaderEmpty({ item }));
  } else {
...
function TableLoaderCell(_a) {
  ...
  return import_react22.default.createElement(TableTdElement, Object.assign({}, props, { isEditable: false, isEditing: false }), props.isRowHeader ? import_react22.default.createElement(ItemsLoader, { item, trackBy }, children) : null);
}
...
var WidthsContext = (0, import_react23.createContext)({
  getColumnStyles: () => ({}),
...
function ColumnWidthsProvider({ visibleColumns, resizableColumns, containerRef, children }) {
  const visibleColumnsRef = (0, import_react23.useRef)(null);
  const containerWidthRef = (0, import_react23.useRef)(0);
  const [columnWidths, setColumnWidths] = (0, import_react23.useState)(null);
  const cellsRef = (0, import_react23.useRef)(/* @__PURE__ */ new Map());
  const stickyCellsRef = (0, import_react23.useRef)(/* @__PURE__ */ new Map());
  ...
  return import_react23.default.createElement(WidthsContext.Provider, { value: { getColumnStyles, columnWidths: columnWidths !== null && columnWidths !== void 0 ? columnWidths : /* @__PURE__ */ new Map(), updateColumn, setCell } }, children);
}
function useColumnWidths() {
  return (0, import_react23.useContext)(WidthsContext);
}
...
function Divider({ className }) {
  return import_react24.default.createElement("span", { className: clsx_m_default(styles_css_default11.divider, styles_css_default11["divider-disabled"], className) });
}
function Resizer({ onWidthUpdate, onWidthUpdateCommit, ariaLabelledby, minWidth = DEFAULT_COLUMN_WIDTH, tabIndex, showFocusRing, focusId, roleDescription }) {
  ...
  const resizerToggleRef = (0, import_react24.useRef)(null);
  const resizerSeparatorRef = (0, import_react24.useRef)(null);
  const [isDragging, setIsDragging] = (0, import_react24.useState)(false);
  const [isKeyboardDragging, setIsKeyboardDragging] = (0, import_react24.useState)(false);
  const autoGrowTimeout = (0, import_react24.useRef)();
  const [resizerHasFocus, setResizerHasFocus] = (0, import_react24.useState)(false);
  const [headerCellWidth, setHeaderCellWidth] = (0, import_react24.useState)(0);
  ...
  return import_react24.default.createElement(
    ...
    null,
    import_react24.default.createElement("button", { ref: resizerToggleRef, className: clsx_m_default(styles_css_default11.resizer, (resizerHasFocus || showFocusRing || isKeyboardDragging) && styles_css_default11["has-focus"], isVisualRefresh && styles_css_default11["is-visual-refresh"]), onMouseDown: (event) => {
      if (event.button !== 0) {
        return;
      }
      event.preventDefault();
...
function ResizeTracker() {
  return import_react24.default.createElement("span", { className: styles_css_default11.tracker });
}
  ...
  return import_react25.default.createElement(
    ...
    import_react25.default.createElement(
      ...
      import_react25.default.createElement(
        ...
        import_react25.default.createElement("span", { className: clsx_m_default(styles_css_default13.outline, outlineClassName, showOutline && styles_css_default13["show-outline"]) })
      ),
      import_react25.default.createElement(
        "span",
        { className: clsx_m_default(styles_css_default13.content, !label && !description && styles_css_default13["empty-content"]) },
        label && import_react25.default.createElement("span", { id: labelId, className: clsx_m_default(styles_css_default13.label, styles_css_default12.label, { [styles_css_default13["label-disabled"]]: disabled }) }, label),
        description && import_react25.default.createElement("span", { id: descriptionId, className: clsx_m_default(styles_css_default13.description, {
...
var CheckboxIcon = (_a) => {
  ...
  return import_react26.default.createElement(
    ...
    import_react26.default.createElement("rect", { className: clsx_m_default(styles_css_default14["styled-box"], {
    ...
    checked || indeterminate ? import_react26.default.createElement("polyline", { className: clsx_m_default(styles_css_default14["styled-line"], {
...
// node_modules/@cloudscape-design/components/checkbox/internal.js
var InternalCheckbox = import_react27.default.forwardRef((_a, ref) => {
  ...
  const baseProps = getBaseProps(rest);
  const checkboxRef = (0, import_react27.useRef)(null);
  ...
  }, styledControl: import_react27.default.createElement(checkbox_icon_default, { checked, indeterminate, disabled, readOnly }), __internalRootRef }, getAnalyticsMetadataAttribute(analyticsMetadata)));
});
...
// node_modules/@cloudscape-design/components/radio-group/radio-button.js
var radio_button_default = import_react28.default.forwardRef(function RadioButton(_a, ref) {
  ...
  const radioButtonRef = (0, import_react28.useRef)(null);
  const mergedRefs = useMergeRefs(radioButtonRef, ref);
  const { tabIndex } = useSingleTabStopNavigation(radioButtonRef);
  return import_react28.default.createElement(AbstractSwitch, Object.assign({ className: clsx_m_default(styles_css_default16.radio, description && styles_css_default16["radio--has-description"], className), controlClassName: styles_css_default16["radio-control"], outlineClassName: styles_css_default16.outline, label, description, disabled, readOnly, controlId }, copyAnalyticsMetadataAttribute(rest), { nativeControl: (nativeControlProps) => import_react28.default.createElement("input", Object.assign({}, nativeControlProps, {
    tabIndex,
    type: "radio",
    ref: mergedRefs,
    name,
  ...
  }, styledControl: import_react28.default.createElement(
    "svg",
    { viewBox: "0 0 100 100", focusable: "false", "aria-hidden": "true" },
    import_react28.default.createElement("circle", { className: clsx_m_default(styles_css_default16["styled-circle-border"], {
    ...
    import_react28.default.createElement("circle", { className: clsx_m_default(styles_css_default16["styled-circle-fill"], {
      [styles_css_default16["styled-circle-disabled"]]: disabled,
...
function SelectionControl(_a) {
  ...
  const { navigationActive } = (0, import_react29.useContext)(SingleTabStopNavigationContext);
...
function useMultiSelection({ ariaLabels, isItemDisabled = () => false, items, loading, onSelectionChange, selectedItems = [], selectionType, trackBy, setLastUserAction }) {
  const selectionControlName = useUniqueId();
  const [shiftPressed, setShiftPressed] = (0, import_react30.useState)(false);
  const [lastClickedItem, setLastClickedItem] = (0, import_react30.useState)(null);
  if (selectionType !== "multi") {
    return { isItemSelected: () => false };
  }
...
function ScreenreaderOnly(props) {
  return import_react31.default.createElement("span", Object.assign({}, props, { className: clsx_m_default(styles_css_default18.root, props.className) }));
}
...
function TableHeaderSelectionCell(_a) {
  ...
  return import_react33.default.createElement(
    ...
    selectAllProps ? import_react33.default.createElement(SelectionControl, Object.assign({ onFocusDown: (event) => {
      onFocusMove(event.target, -1, 1);
    }, focusedComponent }, selectAllProps, props.sticky ? { tabIndex: -1 } : {})) : import_react33.default.createElement(ScreenreaderOnly, null, singleSelectionHeaderAriaLabel),
    import_react33.default.createElement(Divider, { className: styles_css_default4["resize-divider"] })
  );
}
function TableBodySelectionCell(_a) {
  var { selectionControlProps } = _a, props = __rest(_a, ["selectionControlProps"]);
  return import_react33.default.createElement(TableTdElement, Object.assign({}, props, { isSelection: true, wrapLines: false, isEditable: false, isEditing: false, colIndex: 0 }), selectionControlProps ? import_react33.default.createElement(SelectionControl, Object.assign({}, selectionControlProps, { verticalAlign: props.verticalAlign })) : null);
}
...
function TableHeaderCell({ tabIndex, column, activeSortingColumn, sortingDescending, sortingDisabled, wrapLines, focusedComponent, stuck, sticky, hidden, stripedRows, onClick, colIndex, updateColumn, resizableColumns, resizableStyle, onResizeFinish, isEditable, columnId, stickyState, cellRef, tableRole, resizerRoleDescription, isExpandable, hasDynamicContent, variant, tableVariant }) {
  ...
  const clickableHeaderRef = (0, import_react34.useRef)(null);
  const { tabIndex: clickableHeaderTabIndex } = useSingleTabStopNavigation(clickableHeaderRef, { tabIndex });
  const cellRefObject = (0, import_react34.useRef)(null);
  ...
  return import_react34.default.createElement(
    ...
    import_react34.default.createElement(
      ...
      import_react34.default.createElement(
        ...
        column.header,
        isEditable ? import_react34.default.createElement(
          "span",
          { className: styles_css_default19["edit-icon"] },
          import_react34.default.createElement(internal_default, { name: "edit", ariaLabel: i18n("columnDefinitions.editConfig.editIconAriaLabel", (_a = column.editConfig) === null || _a === void 0 ? void 0 : _a.editIconAriaLabel) })
        ) : null
      ),
      sortingStatus && import_react34.default.createElement(
        "span",
        { className: styles_css_default19["sorting-icon"] },
        import_react34.default.createElement(internal_default, { name: getSortingIconName(sortingStatus) })
      )
    ),
    resizableColumns ? import_react34.default.createElement(Resizer, { tabIndex, focusId: `resize-control-${String(columnId)}`, showFocusRing: focusedComponent === `resize-control-${String(columnId)}`, onWidthUpdate: (newWidth) => updateColumn(columnId, newWidth), onWidthUpdateCommit: onResizeFinish, ariaLabelledby: headerId, minWidth: typeof column.minWidth === "string" ? parseInt(column.minWidth) : column.minWidth, roleDescription: i18n("ariaLabels.resizerRoleDescription", resizerRoleDescription) }) : import_react34.default.createElement(Divider, { className: styles_css_default19["resize-divider"] })
  );
}

// node_modules/@cloudscape-design/components/table/thead.js
var Thead = import_react35.default.forwardRef(({ selectionType, getSelectAllProps, columnDefinitions, sortingColumn, sortingDisabled, sortingDescending, resizableColumns, variant, tableVariant, wrapLines, onFocusMove, onSortingChange, onResizeFinish, singleSelectionHeaderAriaLabel, stripedRows, sticky = false, hidden = false, stuck = false, stickyState, selectionColumnId: selectionColumnId2, focusedComponent, onFocusedComponentChange, tableRole, resizerRoleDescription, isExpandable, setLastUserAction }, outerRef) => {
  ...
  return import_react35.default.createElement(
    ...
    import_react35.default.createElement(
      ...
      selectionType ? import_react35.default.createElement(TableHeaderSelectionCell, Object.assign({}, commonCellProps, { focusedComponent, columnId: selectionColumnId2, getSelectAllProps, onFocusMove, singleSelectionHeaderAriaLabel })) : null,
      columnDefinitions.map((column, colIndex) => {
        const columnId = getColumnKey(column, colIndex);
        return import_react35.default.createElement(TableHeaderCell, Object.assign({}, commonCellProps, {
          key: columnId,
          tabIndex: sticky ? -1 : 0,
          focusedComponent,
          column,
...
var useStickyHeader = (tableRef, theadRef, secondaryTheadRef, secondaryTableRef, tableWrapperRef) => {
  ...
  const syncColumnHeaderWidths = (0, import_react36.useCallback)(() => {
...
// node_modules/@cloudscape-design/components/table/sticky-header.js
var sticky_header_default = (0, import_react37.forwardRef)(StickyHeader);
function StickyHeader({ variant, theadProps, wrapperRef, theadRef, secondaryWrapperRef, onScroll, tableRef, tableHasHeader, contentDensity, tableRole }, ref) {
  const secondaryTheadRef = (0, import_react37.useRef)(null);
  const secondaryTableRef = (0, import_react37.useRef)(null);
  const { isStuck } = (0, import_react37.useContext)(StickyHeaderContext);
  const [focusedComponent, setFocusedComponent] = (0, import_react37.useState)(null);
  ...
  return import_react37.default.createElement(
    ...
    import_react37.default.createElement(
      ...
      import_react37.default.createElement(thead_default, Object.assign({ ref: secondaryTheadRef, sticky: true, stuck: isStuck, focusedComponent }, theadProps))
    )
  );
}
...
function useStickyScrollbar(scrollbarRef, scrollbarContentRef, tableRef, wrapperRef, offsetScrollbar) {
  const [inScrollableContainer, setInScrollableContainer] = (0, import_react38.useState)(false);
...
// node_modules/@cloudscape-design/components/table/sticky-scrollbar/sticky-scrollbar.js
var sticky_scrollbar_default = (0, import_react39.forwardRef)(StickyScrollbar);
function StickyScrollbar({ wrapperRef, tableRef, onScroll, hasStickyColumns }, ref) {
  const isVisualRefresh = useVisualRefresh();
  const scrollbarRef = import_react39.default.useRef(null);
  const scrollbarContentRef = import_react39.default.useRef(null);
  ...
  return import_react39.default.createElement(
    ...
    import_react39.default.createElement(
      ...
      import_react39.default.createElement("div", { ref: scrollbarContentRef, className: styles_css_default21["sticky-scrollbar-content"] })
    ),
    import_react39.default.createElement("div", { ref: stickyDetectionRef, style: { position: "absolute", right: 0, bottom: 0, left: 0, height: 1 } })
  );
}
...
function ToolsHeader({ header, filter, pagination, preferences, setLastUserAction }) {
  ...
  const assignHeaderId = (0, import_react40.useContext)(CollectionLabelContext).assignId;
  ...
  return import_react40.default.createElement(
    ...
    null,
    isHeaderString ? import_react40.default.createElement("span", { id: headingId }, header) : header,
    hasTools && import_react40.default.createElement(
      "div",
      { ref, className: clsx_m_default(styles_css_default4.tools, isSmall && styles_css_default4["tools-small"]) },
      filter && import_react40.default.createElement("div", { className: styles_css_default4["tools-filtering"], onClickCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("filter"), onKeyDownCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("filter") }, filter),
      import_react40.default.createElement(
        "div",
        { className: styles_css_default4["tools-align-right"] },
        pagination && import_react40.default.createElement("div", { className: styles_css_default4["tools-pagination"], onClickCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("pagination") }, pagination),
        preferences && import_react40.default.createElement("div", { className: styles_css_default4["tools-preferences"], onClickCapture: () => setLastUserAction === null || setLastUserAction === void 0 ? void 0 : setLastUserAction("preferences") }, preferences)
      )
    )
  );
}
...
function useCellEditing({ onCancel, onSubmit }) {
  const [currentEditCell, setCurrentEditCell] = (0, import_react41.useState)(null);
  const [lastSuccessfulEditCell, setLastSuccessfulEditCell] = (0, import_react41.useState)(null);
  const [currentEditLoading, setCurrentEditLoading] = (0, import_react41.useState)(false);
  const startEdit = (cellId) => {
    setLastSuccessfulEditCell(null);
    setCurrentEditCell(cellId);
  };
  const cancelEdit = (0, import_react41.useCallback)(() => setCurrentEditCell(null), []);
...
function useTableFocusNavigation({ enableKeyboardNavigation, selectionType, tableRoot, columnDefinitions, numRows }) {
  const focusableColumns = (0, import_react43.useMemo)(() => {
  ...
  const focusCell = (0, import_react43.useCallback)((rowIndex, columnIndex) => {
  ...
  const shiftFocus = (0, import_react43.useCallback)((vertical, horizontal) => {
    var _a;
  ...
  const handleArrowKeyEvents = (0, import_react43.useCallback)((event) => {
    var _a, _b;
...
var InternalTableAsSubstep = import_react44.default.forwardRef((props, ref) => {
  ...
  return import_react44.default.createElement(InternalTable, Object.assign({}, tableProps, { ref }));
});
var InternalTable = import_react44.default.forwardRef((_a, ref) => {
  var _b, _c, _d;
  ...
  const wrapperMeasureRefObject = (0, import_react44.useRef)(null);
  ...
  const tableRefObject = (0, import_react44.useRef)(null);
  const secondaryWrapperRef = import_react44.default.useRef(null);
  const theadRef = (0, import_react44.useRef)(null);
  const stickyHeaderRef = import_react44.default.useRef(null);
  ...
  const paginationRef = (0, import_react44.useRef)({});
  const filterRef = (0, import_react44.useRef)({});
  const preferencesRef = (0, import_react44.useRef)({});
  const headerRef = (0, import_react44.useRef)({});
  const getHeaderText = () => {
    var _a2, _b2, _c2, _d2;
  ...
  const wrapperRefObject = (0, import_react44.useRef)(null);
  ...
  const headerIdRef = (0, import_react44.useRef)(void 0);
  ...
  const setHeaderRef = (0, import_react44.useCallback)((id) => {
  ...
  const toolsHeaderPerformanceMarkRef = (0, import_react44.useRef)(null);
  ...
  return import_react44.default.createElement(
    ...
    import_react44.default.createElement(
      ...
      import_react44.default.createElement(
        ...
        import_react44.default.createElement(
          InternalContainer,
          Object.assign({}, baseProps, tableInteractionAttributes, { __internalRootRef, className: clsx_m_default(baseProps.className, styles_css_default4.root), __funnelSubStepProps, __fullPage: variant === "full-page", header: import_react44.default.createElement(
            import_react44.default.Fragment,
            null,
            hasHeader && import_react44.default.createElement(
              "div",
              null,
              import_react44.default.createElement(
                "div",
                ...
                import_react44.default.createElement(
                  ...
                  import_react44.default.createElement(ToolsHeader, { header, filter, pagination, preferences, setLastUserAction })
                )
              )
            ),
            stickyHeader && import_react44.default.createElement(sticky_header_default, { ref: stickyHeaderRef, variant: computedVariant, theadProps, wrapperRef: wrapperRefObject, theadRef, secondaryWrapperRef, tableRef: tableRefObject, onScroll: handleScroll, tableHasHeader: hasHeader, contentDensity, tableRole })
          ), disableHeaderPaddings: true, disableContentPaddings: true, disableFooterPaddings: true, variant: toContainerVariant(computedVariant), __disableFooterDivider: true, __disableStickyMobile: false, footer: hasFooter ? import_react44.default.createElement(
            "div",
            ...
            import_react44.default.createElement(
              ...
              footer && import_react44.default.createElement("span", null, footer),
              hasFooterPagination && import_react44.default.createElement("div", { className: styles_css_default4["footer-pagination"] }, pagination)
            )
          ...
          import_react44.default.createElement(
            ...
            import_react44.default.createElement("div", { className: styles_css_default4["wrapper-content-measure"], ref: wrapperMeasureMergedRef }),
            !!renderAriaLive && !!firstIndex && import_react44.default.createElement(
              internal_default2,
              { hidden: true, tagName: "span" },
              import_react44.default.createElement("span", null, renderAriaLive({
                firstIndex,
            ...
            import_react44.default.createElement(
              ...
              import_react44.default.createElement(
                ...
                import_react44.default.createElement(thead_default, Object.assign({ ref: theadRef, hidden: stickyHeader, onFocusedComponentChange: (focusId) => {
                  var _a2;
                  return (_a2 = stickyHeaderRef.current) === null || _a2 === void 0 ? void 0 : _a2.setFocus(focusId);
                } }, theadProps)),
                import_react44.default.createElement("tbody", null, loading || allItems.length === 0 ? import_react44.default.createElement(
                  "tr",
                  null,
                  import_react44.default.createElement(NoDataCell, { totalColumnsCount, hasFooter, loading, loadingText, empty, tableRef: tableRefObject, containerRef: wrapperMeasureRefObject })
                  ...
                  if (row.type === "data") {
                    ...
                    return import_react44.default.createElement(
                      ...
                      visibleColumnDefinitions.map((column, colIndex) => {
                        ...
                        return import_react44.default.createElement(TableBodyCell, Object.assign({ key: colId }, sharedCellProps, { resizableStyle: {
                          width: column.width,
                          minWidth: column.minWidth,
                  ...
                  return loaderContent && import_react44.default.createElement(
                    "tr",
                    ...
                    getItemSelectionProps && import_react44.default.createElement(TableBodySelectionCell, Object.assign({}, sharedCellProps, { columnId: selectionColumnId, verticalAlign: cellVerticalAlign, tableVariant: computedVariant })),
                    visibleColumnDefinitions.map((column, colIndex) => {
                      var _a2;
                      return import_react44.default.createElement(TableLoaderCell, Object.assign({ key: getColumnKey(column, colIndex) }, sharedCellProps, { wrapLines: false, columnId: (_a2 = column.id) !== null && _a2 !== void 0 ? _a2 : colIndex, colIndex: colIndex + colIndexOffset, isRowHeader: colIndex === 0, level: row.level, item: row.item, trackBy }), loaderContent);
                    })
                  );
                }))
              )
            ),
            resizableColumns && import_react44.default.createElement(ResizeTracker, null)
          ),
          import_react44.default.createElement(sticky_scrollbar_default, { ref: scrollbarRef, wrapperRef: wrapperRefObject, tableRef: tableRefObject, onScroll: handleScroll, hasStickyColumns })
        )
      )
    )
  );
...
// node_modules/@cloudscape-design/components/table/index.js
var Table = import_react45.default.forwardRef((_a, ref) => {
  var _b, _c, _d;
  ...
  if (variant === "borderless" || variant === "embedded") {
    return import_react45.default.createElement(
      ...
      import_react45.default.createElement(internal_default7, Object.assign({}, tableProps))
    );
  }
  return import_react45.default.createElement(
    CollectionPreferencesMetadata.Provider,
    ...
    import_react45.default.createElement(
      AnalyticsFunnelSubStep,
      null,
      import_react45.default.createElement(InternalTableAsSubstep, Object.assign({}, tableProps))
    )
  );
});
...
//# sourceMappingURL=chunk-A2X632MI.js.map
