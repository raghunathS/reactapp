...
export class TicketsApiClient {
  ...
  public async getEnvironmentSummary(year?: number): Promise<EnvironmentSummaryResponse> {
    const url = year
      ? `${API_BASE_URL}/environment-summary?year=${year}`
      : `${API_BASE_URL}/environment-summary`;
